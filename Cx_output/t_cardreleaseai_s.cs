...
{
public static List<Cfg_t_cardreleaseai_s_Info> list = new List<Cfg_t_cardreleaseai_s_Info>()
{
	[0] = new Cfg_t_cardreleaseai_s_Info(1,1,"1,5000"),
	[1] = new Cfg_t_cardreleaseai_s_Info(2,2,"2,5000"),
	[2] = new Cfg_t_cardreleaseai_s_Info(3,3,"3,5000"),
	[3] = new Cfg_t_cardreleaseai_s_Info(4,4,"4,7000;3,3000"),
	[4] = new Cfg_t_cardreleaseai_s_Info(5,5,"1,3000;2,7000"),
	[5] = new Cfg_t_cardreleaseai_s_Info(6,6,"1,5000;3,5000"),
	[6] = new Cfg_t_cardreleaseai_s_Info(7,7,"2,5000;3,5000"),
	[7] = new Cfg_t_cardreleaseai_s_Info(8,8,"1,5000;2,5000;3,5000"),
	[8] = new Cfg_t_cardreleaseai_s_Info(9,9,"4,5000;2,5000"),
	[9] = new Cfg_t_cardreleaseai_s_Info(10,10,"5,1000"),
};
}
