...
public class Cfg_t_matchpoint_s_Info
{
public int id;
...
{
public static List<Cfg_t_matchpoint_s_Info> list = new List<Cfg_t_matchpoint_s_Info>()
{
	[0] = new Cfg_t_matchpoint_s_Info(1,1,"0,500",5,0),
	[1] = new Cfg_t_matchpoint_s_Info(2,2,"501,1000",6,-1),
	[2] = new Cfg_t_matchpoint_s_Info(3,3,"1001,2500",13,-8),
	[3] = new Cfg_t_matchpoint_s_Info(4,4,"2501,5000",32,-27),
	[4] = new Cfg_t_matchpoint_s_Info(5,5,"5001,8000",69,-64),
	[5] = new Cfg_t_matchpoint_s_Info(6,6,"8001,9999",130,-125),
};
}
