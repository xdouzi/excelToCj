...
public class Cfg_t_bigmap_Info
{
public int id;
...
{
public static List<Cfg_t_bigmap_Info> list = new List<Cfg_t_bigmap_Info>()
{
	[0] = new Cfg_t_bigmap_Info(1,1,"1,5000;7,5000","50,50",10000,"0,0;1,10000","","15,15;50,50"),
};
}
