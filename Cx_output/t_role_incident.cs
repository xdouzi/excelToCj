...
public class t_role_incidentInfo
{
public int id;
...
{
public static List<t_role_incidentInfo> list = new List<t_role_incidentInfo>()
{
	[0] = new t_role_incidentInfo(1,1,"","","","",""),
	[1] = new t_role_incidentInfo(2,2,"","","","",""),
};
}
