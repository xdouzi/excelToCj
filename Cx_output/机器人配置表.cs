...
{
public static List<机器人配置表Info> list = new List<机器人配置表Info>()
{
	[0] = new 机器人配置表Info("8000","3","25","8000,3,25"),
	[1] = new 机器人配置表Info("9999","8","30","9999,8,30"),
	[2] = new 机器人配置表Info("","","",""),
	[3] = new 机器人配置表Info("500","6","10","500,6,10"),
	[4] = new 机器人配置表Info("1000","11","15","1000,11,15"),
	[5] = new 机器人配置表Info("2500","16","20","2500,16,20"),
	[6] = new 机器人配置表Info("5000","21","25","5000,21,25"),
	[7] = new 机器人配置表Info("8000","26","30","8000,26,30"),
	[8] = new 机器人配置表Info("9999","31","35","9999,31,35"),
	[9] = new 机器人配置表Info("","","",""),
	[10] = new 机器人配置表Info("500","11","15","500,11,15"),
	[11] = new 机器人配置表Info("1000","16","20","1000,16,20"),
	[12] = new 机器人配置表Info("2500","21","25","2500,21,25"),
	[13] = new 机器人配置表Info("5000","26","30","5000,26,30"),
	[14] = new 机器人配置表Info("8000","31","35","8000,31,35"),
	[15] = new 机器人配置表Info("9999","36","40","9999,36,40"),
	[16] = new 机器人配置表Info("","","",""),
	[17] = new 机器人配置表Info("500","16","20","500,16,20"),
	[18] = new 机器人配置表Info("1000","21","25","1000,21,25"),
	[19] = new 机器人配置表Info("2500","26","30","2500,26,30"),
	[20] = new 机器人配置表Info("5000","31","35","5000,31,35"),
	[21] = new 机器人配置表Info("8000","36","40","8000,36,40"),
	[22] = new 机器人配置表Info("9999","41","45","9999,41,45"),
	[23] = new 机器人配置表Info("","","",""),
	[24] = new 机器人配置表Info("500","21","25","500,21,25"),
	[25] = new 机器人配置表Info("1000","26","30","1000,26,30"),
	[26] = new 机器人配置表Info("2500","31","35","2500,31,35"),
	[27] = new 机器人配置表Info("5000","36","40","5000,36,40"),
	[28] = new 机器人配置表Info("8000","41","45","8000,41,45"),
	[29] = new 机器人配置表Info("9999","46","50","9999,46,50"),
};
}
