...
{
	[0] = new Cfg_t_card_group_s_Info(1,10200,"0",20010200,1,2,1,1,2,1,6,10000009,20000009,15000,8000,0,"-5,50","","","","","","",21010200,"0,-1,10","1,1,1","0.03,-0.02,0","Hero/Spine/wanjianqifa/skeleton_SkeletonData",),
	[1] = new Cfg_t_card_group_s_Info(2,10201,"0",20010201,1,2,3,1,4,1,6,10000001,20000001,8000,8000,0,"-5,50","","","","","","",21010201,"0,1,12","1,1,1","0,0.18,0","Hero/Spine/dianjifashu/skeleton_SkeletonData",),
	[2] = new Cfg_t_card_group_s_Info(3,10202,"0",20010202,0,2,2,1,3,2,6,10000014,20000014,10000,8000,0,"-5,50","","","","","","",21010202,"0,-1.1,6.9","1,1,1","0,0,0","Hero/Spine/duyaofashu/skeleton_SkeletonData",),
	[3] = new Cfg_t_card_group_s_Info(4,10203,"0",20010203,0,2,1,1,2,2,6,10000015,20000015,10000,8000,0,"-5,50","","","","","","",21010203,"0,-1.1,6.9","2.73,2.73,2.73","0,0,0","Hero/Spine/huoqiu/skeleton_SkeletonData",),
	[4] = new Cfg_t_card_group_s_Info(5,10204,"0",20010204,1,2,4,1,5,1,6,10000002,20000002,8000,8000,1,"-5,50","","","","","","",21010204,"0,0,12","1,1,1","-0.02,0.12,0","Hero/Spine/gunmu/skeleton_SkeletonData",),
	[5] = new Cfg_t_card_group_s_Info(6,10300,"0",20010300,0,2,2,1,3,3,6,10000026,20000026,10000,8000,0,"-5,50","","","","","","",21010300,"0,-1.1,6.9","3.12,3.12,3.12","0,0,0","Hero/Spine/chuanshanjiazhanshi/chuanshanjiazhanshi_SkeletonData",),
	[6] = new Cfg_t_card_group_s_Info(7,10301,"0",20010301,0,2,3,1,4,3,6,10000027,20000027,10000,8000,0,"-5,50","","","","","","",21010301,"0,-1.1,6.9","3.12,3.12,3.12","0,0,0","Hero/Spine/chuanshanjiazhanshi/chuanshanjiazhanshi_SkeletonData",),
	[7] = new Cfg_t_card_group_s_Info(8,10302,"0",20010302,0,2,4,1,5,3,6,10000028,20000028,10000,8000,1,"-5,50","","","","","","",21010302,"0,-1.1,6.9","3.12,3.12,3.12","0,0,0","Hero/Spine/chuanshanjiazhanshi/chuanshanjiazhanshi_SkeletonData",),
	[8] = new Cfg_t_card_group_s_Info(9,10400,"0",20010400,0,2,3,1,4,4,6,10000042,20000042,10000,8000,0,"-5,50","","","","","","",21010400,"0,0,10","1,1,1","0,0,0","Hero/Spine/chuanshanjiazhanshi/chuanshanjiazhanshi_SkeletonData",),
	[9] = new Cfg_t_card_group_s_Info(10,10401,"0",20010401,0,2,3,1,4,4,6,10000043,20000043,10000,8000,0,"-5,50","","","","","","",21010401,"0,-1.1,6.9","3.12,3.12,3.12","0,0,0","Hero/Spine/chuanshanjiazhanshi/chuanshanjiazhanshi_SkeletonData",),
	[10] = new Cfg_t_card_group_s_Info(11,10402,"0",20010402,0,2,2,1,3,4,6,10000044,20000044,10000,8000,0,"-5,50","","","","","","",21010402,"0,-1.1,6.9","3.12,3.12,3.12","0,0,0","Hero/Spine/chuanshanjiazhanshi/chuanshanjiazhanshi_SkeletonData",),
	[11] = new Cfg_t_card_group_s_Info(12,10500,"0",20010500,0,2,4,1,5,5,6,10000057,20000057,10000,8000,1,"-5,50","","","","","","",21010500,"0,-1.1,6.9","3.12,3.12,3.12","0,0,0","Hero/Spine/chuanshanjiazhanshi/chuanshanjiazhanshi_SkeletonData",),
	[12] = new Cfg_t_card_group_s_Info(13,10501,"0",20010501,0,2,3,1,4,5,6,10000058,20000058,10000,8000,0,"-5,50","","","","","","",21010501,"0,-1.1,6.9","3.12,3.12,3.12","0,0,0","Hero/Spine/chuanshanjiazhanshi/chuanshanjiazhanshi_SkeletonData",),
	...
	[70] = new Cfg_t_card_group_s_Info(71,100001,"0",20100001,0,2,1,1,2,1,6,46000021,40000021,10000,8000,0,"-5,50","","","","","","",21100001,"0,-1.1,6.9","3.12,3.12,3.12","0,0,0","Hero/Spine/dianjifashu/skeleton_SkeletonData",),
	[71] = new Cfg_t_card_group_s_Info(72,100002,"0",20100002,0,2,1,1,2,1,6,46000022,40000022,10000,8000,0,"-5,50","","","","","","",21100002,"0,-1.1,6.9","0.78,0.78,0.78","0,0,0","Hero/Spine/dianjifashu/skeleton_SkeletonData",),
	[72] = new Cfg_t_card_group_s_Info(73,100003,"0",20100003,0,2,1,1,2,1,6,46000023,40000023,10000,8000,0,"-5,50","","","","","","",21100003,"0,-1.1,6.9","0.78,0.78,0.78","0,0,0","Hero/Spine/dianjifashu/skeleton_SkeletonData",),
	[73] = new Cfg_t_card_group_s_Info(74,100004,"0",20100004,0,2,1,1,2,1,6,46000024,40000024,10000,8000,0,"-5,50","","","","","","",21100004,"0,-1.1,6.9","0.78,0.78,0.78","0,0,0","Hero/Spine/dianjifashu/skeleton_SkeletonData",),
	[74] = new Cfg_t_card_group_s_Info(75,100005,"0",20100005,0,2,1,1,2,1,6,46000025,40000025,10000,8000,0,"-5,50","","","","","","",21100005,"0,-1.1,6.9","0.78,0.78,0.78","0,0,0","Hero/Spine/dianjifashu/skeleton_SkeletonData",),
	[75] = new Cfg_t_card_group_s_Info(76,100006,"0",20100006,0,0,1,1,2,1,6,46000011,40000011,10000,8000,0,"-5,50","","","","","","",21100006,"0,-1.1,6.9","3.12,3.12,3.12","0,0,0","Hero/Spine/dianjifashu/skeleton_SkeletonData",),
	[76] = new Cfg_t_card_group_s_Info(77,100007,"0",20100007,0,2,1,1,2,1,6,46000013,40000013,10000,8000,0,"-5,50","","","","","","",21100007,"0,-1.1,6.9","0.78,0.78,0.78","0,0,0","Hero/Spine/dianjifashu/skeleton_SkeletonData",),
	[77] = new Cfg_t_card_group_s_Info(78,100008,"0",20100008,0,0,1,1,2,1,6,46000015,40000015,10000,8000,0,"-5,50","","","","","","",21100008,"0,-1.1,6.9","0.78,0.78,0.78","0,0,0","Hero/Spine/dianjifashu/skeleton_SkeletonData",),
	[78] = new Cfg_t_card_group_s_Info(79,100009,"0",20100009,0,2,1,1,2,1,6,46000027,40000027,10000,8000,0,"-5,50","","","","","","",21100009,"0,-1.1,6.9","0.78,0.78,0.78","0,0,0","Hero/Spine/dianjifashu/skeleton_SkeletonData",),
	[79] = new Cfg_t_card_group_s_Info(80,100010,"0",20100010,0,2,1,1,2,1,6,46000028,40000028,10000,8000,0,"-5,50","","","","","","",21100010,"0,-1.1,6.9","0.78,0.78,0.78","0,0,0","Hero/Spine/dianjifashu/skeleton_SkeletonData",),
	[80] = new Cfg_t_card_group_s_Info(81,100011,"0",20100011,0,2,1,1,2,1,6,46000029,40000029,10000,8000,0,"-5,50","","","","","","",21100011,"0,-1.1,6.9","0.78,0.78,0.78","0,0,0","Hero/Spine/dianjifashu/skeleton_SkeletonData",),
	[81] = new Cfg_t_card_group_s_Info(82,100012,"0",20100012,0,2,1,1,2,1,6,46000030,40000030,10000,8000,0,"-5,50","","","","","","",21100012,"0,-1.1,6.9","0.78,0.78,0.78","0,0,0","Hero/Spine/dianjifashu/skeleton_SkeletonData",),
	[82] = new Cfg_t_card_group_s_Info(83,100013,"0",20100013,0,2,1,1,2,1,6,46000031,40000031,10000,8000,0,"-5,50","","","","","","",21100013,"0,-1.1,6.9","0.78,0.78,0.78","0,0,0","Hero/Spine/dianjifashu/skeleton_SkeletonData",),
};
}
