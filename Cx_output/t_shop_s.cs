...
{
	[0] = new Cfg_t_shop_s_Info(1,1,"Limit_shop",8201,"","0 8 * * *;0 12 * * *;0 18 * * *","",,"701",0,"",1,),
	[1] = new Cfg_t_shop_s_Info(2,2,"Item_shop",8202,"2,19,1","0 8 * * *","-1,0;-1,20;-1,50;-1,50;-1,100;-1,100;-1,200;-1,200",4,"101,102,103,104,105,106,107,108,109,110,111,112",0,"",3,),
	[2] = new Cfg_t_shop_s_Info(3,3,"Card_shop",8203,"2,17,1","0 8 * * *;0 18 * * *","",,"401,402,403,404,405,406",0,"",1,),
	[3] = new Cfg_t_shop_s_Info(4,4,"Box_shop",8204,"","0 8 * * * ","",,"501,502,503",0,"",1,50),
	[4] = new Cfg_t_shop_s_Info(5,5,"Gold_shop",8205,"","","",,"601,602,603",0,"",1,),
	[5] = new Cfg_t_shop_s_Info(6,6,"Sacrifice",8206,"2,6,1","0 8 * * * ","",,"201,202,203,204,205,206",0,"",2,),
	[6] = new Cfg_t_shop_s_Info(7,7,"Greed_shop",8207,"2,6,1","0 8 * * *;0 18 * * *","",,"301,302,303,304,305,306",0,"",2,),
	[7] = new Cfg_t_shop_s_Info(8,8,"Vip_exp_shop",8208,"","","",,"801,802,803,804,805",0,"",4,),
	[8] = new Cfg_t_shop_s_Info(9,9,"Vip_privilege_shop",8209,"","0 4 * * *","-1,0;-1,20;-1,50;-1,50;-1,100;-1,100;-1,200;-1,200",4,"901,902,903,904,905,906,907,908,909,910,911,912",0,"",5,),
};
}
