...
{
public static List<Cfg_t_home_Info> list = new List<Cfg_t_home_Info>()
{
	[%!d(string=1)] = new Cfg_t_home_Info(1,1,1,"1,2,3",0,"","1,1,2,2",20005,"-2,100",,,,1,"7.73,-5.53",20005,"0,10000","","",15000),
	[%!d(string=2)] = new Cfg_t_home_Info(2,2,2,"4",1,"4,2","1,1,2,2",20005,"-2,101",,,,,"0,0",20005,"0,10000","","",15000),
	[%!d(string=3)] = new Cfg_t_home_Info(3,3,3,"5",1,"4,3","1,1,2,2",20005,"-2,102",,,,,"0,0",20005,"0,10000","","",15000),
	[%!d(string=4)] = new Cfg_t_home_Info(4,4,4,"6",1,"4,4","1,1,2,2",20005,"-2,103",,,,,"0,0",20005,"0,10000","","",15000),
	[%!d(string=5)] = new Cfg_t_home_Info(5,5,5,"6",1,"4,5","1,1,2,2",20005,"-2,104",,,,,"0,0",20005,"0,10000","","",15000),
};
}
